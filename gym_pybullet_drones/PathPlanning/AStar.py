...
class AStar():
    ...
    def graph_change(self, position,flag):
        ...
        for i in range(int(position[0]-0.2/self.global_data["length"]), int(position[0]+0.2/self.global_data["length"])):
            for j in range(int(position[1]-0.2/self.global_data["length"]), int(position[1]+0.2/self.global_data["length"])):
                for k in range(int(position[2]-0.2/self.global_data["length"]), int(position[2]+0.2/self.global_data["length"])):
